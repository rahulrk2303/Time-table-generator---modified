    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('time', models.CharField(choices=[('Period 1', '8:30 - 9.20'),('Period 2', '8:30 - 9.20'),('Period 3', '10:25 - 11:15'),('Period 4', '11:15 - 12:05'),('Period 5', '12:45 - 1:35'),('Period 6', '1:35 - 2:25'),('Period 7', '2:25 - 3:15')], default='11:30 - 12:30', max_length=50)),
